...
/* ── Load painting overrides from localStorage (set by admin) ── */
...
var i18n = {
  en: {
    ...
    'resume-heading-contact': 'Contact', 'resume-studio-label': 'Studio', 'resume-email-label': 'Email',
  ...
  de: {
    ...
    'resume-heading-contact': 'Kontakt', 'resume-studio-label': 'Atelier', 'resume-email-label': 'E-Mail',
